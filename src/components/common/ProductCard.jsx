      ...
      <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr_220px] gap-8 items-center">
        ...
        <div className="flex items-center justify-end">
          <Link
            ...
            className="w-[190px] h-[58px] flex items-center justify-center rounded-2xl bg-[#b03333] hover:bg-[#8f1f1f] !text-white text-lg font-semibold transition-all duration-300"
          >
            Get Quote
          </Link>
        </div>
